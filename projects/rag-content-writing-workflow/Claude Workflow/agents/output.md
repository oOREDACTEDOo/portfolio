...
- `previewUrl` — `assets.preview_1000.url` (watermarked JPEG, standard CDN format — do NOT use `preview_1500` which uses `z/` format URLs that fail to embed in Google Docs)
...
<style>
  body { font-family: 'Poppins', Arial, sans-serif; font-size: 11pt; line-height: 1.7; color: #2d2d2d; max-width: 680px; margin: 0 auto; }
...
<div style="margin:16pt 0 24pt;text-align:center;">
  <img src="[heroImage.previewUrl]" alt="[deliverables.image_alt_suggestion]"
       width="620"
       style="width:620px;height:auto;display:block;margin:0 auto;border-radius:6px;">
